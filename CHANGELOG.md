...
- Extended the holding detail dialog by adding a copy-to-clipboard button for the ISIN number
- Extended the holding detail dialog by adding a copy-to-clipboard button for the symbol
