...
- Migrated the get country and sector weightings, dividends, historical price, profile, quote and symbol search functionalities of the _Financial Modeling Prep_ service to its stable API version
