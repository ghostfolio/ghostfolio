...
export type PropertyKey =
  | typeof PROPERTY_API_KEY_GHOSTFOLIO
  | typeof PROPERTY_API_KEY_OPENROUTER
  | typeof PROPERTY_BENCHMARKS
  | typeof PROPERTY_BETTER_UPTIME_MONITOR_ID
  | typeof PROPERTY_COUNTRIES_OF_SUBSCRIBERS
  | typeof PROPERTY_COUPONS
  | typeof PROPERTY_CURRENCIES
  | typeof PROPERTY_CUSTOM_CRYPTOCURRENCIES
  | typeof PROPERTY_DATA_SOURCE_MAPPING
  | typeof PROPERTY_DATA_SOURCES_GHOSTFOLIO_DATA_PROVIDER_MAX_REQUESTS
  | typeof PROPERTY_DEMO_ACCOUNT_ID
  | typeof PROPERTY_DEMO_USER_ID
  | typeof PROPERTY_DOCKER_HUB_PULLS
  | typeof PROPERTY_GITHUB_CONTRIBUTORS
  | typeof PROPERTY_GITHUB_STARGAZERS
  | typeof PROPERTY_IS_DATA_GATHERING_ENABLED
  | typeof PROPERTY_IS_READ_ONLY_MODE
  | typeof PROPERTY_IS_USER_SIGNUP_ENABLED
  | typeof PROPERTY_OPENROUTER_MODEL
  | typeof PROPERTY_OPENROUTER_MODEL_WEB_FETCH
  | typeof PROPERTY_PROXY_ROUTES
  | typeof PROPERTY_REFERRAL_PARTNERS
  | typeof PROPERTY_SLACK_COMMUNITY_USERS
  | typeof PROPERTY_STRIPE_CONFIG
  | typeof PROPERTY_SYSTEM_MESSAGE
  | typeof PROPERTY_UPTIME
  | typeof PROPERTY_WEB_FETCH_ROUTES;
