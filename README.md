...
| `ENABLE_FEATURE_RATE_LIMITING` | `boolean` (optional)  | `false`               | Enables API rate limiting. When running behind a reverse proxy, also set `TRUST_PROXY`, otherwise the rate limits are shared across all clients                                                                               |
