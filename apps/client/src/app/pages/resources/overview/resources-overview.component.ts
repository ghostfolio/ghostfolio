...
export class ResourcesOverviewComponent {
  public overviewItems = [
    {
      description: $localize`Find quick answers to commonly asked questions about Ghostfolio in our Frequently Asked Questions (FAQ) section.`,
      routerLink: publicRoutes.faq.routerLink,
      title: publicRoutes.faq.title
    },
    {
      description: $localize`Explore our guides to help you get started with investing and managing your finances.`,
      routerLink: publicRoutes.resources.subRoutes.guides.routerLink,
      title: publicRoutes.resources.subRoutes.guides.title
    },
    {
      description: $localize`Access various market resources and tools to stay informed about financial markets.`,
      routerLink: publicRoutes.resources.subRoutes.markets.routerLink,
      title: publicRoutes.resources.subRoutes.markets.title
    },
    {
      description: $localize`Learn key financial terms and concepts in our comprehensive glossary.`,
